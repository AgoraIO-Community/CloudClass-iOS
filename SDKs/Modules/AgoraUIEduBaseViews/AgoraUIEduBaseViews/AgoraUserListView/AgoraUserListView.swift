...
public class AgoraUserListView : AgoraBaseUIView {    
    public enum UserCellType: String{
        case `default` = "None"
        case smallCn = "SmallCNCellId"
        case smallNonCn = "SmallNonCNCellId"
        case bigCn = "BigCnCellId"
        case bigNonCn = "BigNonCnCellId"
    }
    ...
    private lazy var listHeader : AgoraBaseUIView = {
        ...
        // width: middle->548,big->300
        let smallCNTextArr: [String : CGFloat] = [
            AgoraKitLocalizedString("UserListName") : CGFloat(22 + 91.3 * 0),
            AgoraKitLocalizedString("UserListCoVideo") : CGFloat(22 + 91.3 * 1),
            AgoraKitLocalizedString("UserListBoard") : CGFloat(22 + 91.3 * 2),
            AgoraKitLocalizedString("UserListCamera") : CGFloat(22 + 91.3 * 3),
            AgoraKitLocalizedString("UserListMicro") : CGFloat(22 + 91.3 * 4),
            AgoraKitLocalizedString("UserListReward") : CGFloat(22 + 91.3 * 5)];
        
        let smallNonCNTextArr: [String : CGFloat] = [
        ...
        let bigCNTextArr: [String : CGFloat] = [
            AgoraKitLocalizedString("UserListName") : CGFloat(22 + 100 * 0),
            AgoraKitLocalizedString("UserListCamera") : CGFloat(22 + 100 * 1),
            AgoraKitLocalizedString("UserListMicro") : CGFloat(22 + 100 * 2)];
        
        let bigNonCNTextArr: [String : CGFloat] = [
            AgoraKitLocalizedString("UserListName") : 22,
        ...
        switch cellType {
        case .bigCn:
            textArr = bigCNTextArr
        case .bigNonCn:
            textArr = bigNonCNTextArr
        case .smallCn:
            textArr = smallCNTextArr
        case .smallNonCn:
            textArr = smallNonCNTextArr
        default:
            textArr = nil
        }
