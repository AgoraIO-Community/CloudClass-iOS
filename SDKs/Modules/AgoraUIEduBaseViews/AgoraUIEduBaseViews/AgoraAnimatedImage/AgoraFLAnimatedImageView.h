...
@class AgoraFLAnimatedImage;
@protocol AgoraFLAnimatedImageViewDebugDelegate;


//
//  An `AgoraFLAnimatedImageView` can take an `AgoraFLAnimatedImage` and plays it automatically when in view hierarchy and stops when removed.
...
@interface AgoraFLAnimatedImageView : UIImageView
...
@property (nonatomic, strong) AgoraFLAnimatedImage *animatedImage;
