...
struct FcrUIComponentToast: FcrUIComponentProtocol {
    ...
    let noticeImage  = UIImage.edu_ui_named("toast_notice")
    let warningImage = UIImage.edu_ui_named("toast_warning")
    let errorImage = UIImage.edu_ui_named("toast_warning")
...
struct FcrUIComponentRaiseHand: FcrUIComponentProtocol {
    ...
    var normalImage: UIImage?            = .edu_ui_named("toolbar_unselected_wave_hands")
    var popOverImage: UIImage?           = .edu_ui_named("toolbar_handsup_remind_popover")
...
struct FcrUIComponentRoster: FcrUIComponentProtocol {
    ...
    // ui
    var normalImage: UIImage?   = .edu_ui_named("toolbar_unselected_roster")
    var selectedImage: UIImage? = .edu_ui_named("toolbar_selected_roster")
...
struct FcrUIComponentRecord: FcrUIComponentProtocol {
    ...
    var image: UIImage?    =  .edu_ui_named("ic_toolbox_record")
...
struct FcrUIComponentHandsList: FcrUIComponentProtocol {
    ...
    let onImage: UIImage?     =  .edu_ui_named("ic_handsup_on_stage")
    let offImage: UIImage?    =  .edu_ui_named("ic_handsup_off_stage")
...
struct FcrUIComponentPopupQuiz: FcrUIComponentProtocol {
    ...
    var image: UIImage?  =  .edu_ui_named("ic_toolbox_answer")
}
...
struct FcrUIComponentCounter: FcrUIComponentProtocol {
    ...
    var image: UIImage?    =  .edu_ui_named("ic_toolbox_clock")
}
...
struct FcrUIComponentPoll: FcrUIComponentProtocol {
    ...
    var image: UIImage?          =  .edu_ui_named("ic_toolbox_vote")
}
...
struct FcrUIComponentCloudStorage: FcrUIComponentProtocol {
    ...
    var image: UIImage? =  .edu_ui_named("toolcollection_enabled_cloud")
}
