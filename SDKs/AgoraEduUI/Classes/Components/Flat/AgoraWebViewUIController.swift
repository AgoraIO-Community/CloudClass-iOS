...
class AgoraWebViewUIController: UIViewController {
    /**context**/
...
extension AgoraWebViewUIController: AgoraUIActivity {
    func viewWillActive() {
...
extension AgoraWebViewUIController: AgoraEduRoomHandler {
    func onJoinRoomSuccess(roomInfo: AgoraEduContextRoomInfo) {
        viewWillActive()
    }
}

extension AgoraWebViewUIController: AgoraEduSubRoomHandler {
...
extension AgoraWebViewUIController: AgoraWidgetActivityObserver {
...
extension AgoraWebViewUIController: AgoraWidgetSyncFrameObserver {
...
extension AgoraWebViewUIController: AgoraWidgetMessageObserver {
...
private extension AgoraWebViewUIController {
...
extension AgoraWebViewUIController: UIGestureRecognizerDelegate {
