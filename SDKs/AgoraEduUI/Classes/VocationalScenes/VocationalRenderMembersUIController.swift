...
@objc extension VocationalRenderMembersUIController: AgoraUIActivity, AgoraUIContentContainer {
    // AgoraUIActivity
    func viewWillActive() {
        registerHandlers()
        createAllRender()
...
extension VocationalRenderMembersUIController: UICollectionViewDataSource, UICollectionViewDelegate {
...
extension VocationalRenderMembersUIController: AgoraWidgetActivityObserver {
...
extension VocationalRenderMembersUIController: AgoraEduMediaHandler {
...
extension VocationalRenderMembersUIController: AgoraEduStreamHandler {
...
extension VocationalRenderMembersUIController: AgoraEduRoomHandler {
    func onJoinRoomSuccess(roomInfo: AgoraEduContextRoomInfo) {
        viewWillActive()
    }
}

extension VocationalRenderMembersUIController: AgoraEduSubRoomHandler {
...
// MARK: - actions
extension VocationalRenderMembersUIController {
...
// MARK: - private
private extension VocationalRenderMembersUIController {
    // model to view
