...
protocol VocationalWindowUIControllerDelegate: NSObjectProtocol {
    /** 获取目标视图 */
...
class VocationalWindowUIController: UIViewController {
    ...
    weak var delegate: VocationalWindowUIControllerDelegate?
    ...
    init(context: AgoraEduContextPool,
         ...
         delegate: VocationalWindowUIControllerDelegate? = nil) {
...
extension VocationalWindowUIController: AgoraUIActivity {
    func viewWillActive() {
...
extension VocationalWindowUIController: AgoraEduRoomHandler {
    func onJoinRoomSuccess(roomInfo: AgoraEduContextRoomInfo) {
        viewWillActive()
    }
}

extension VocationalWindowUIController: AgoraEduSubRoomHandler {
...
extension VocationalWindowUIController: AgoraWidgetActivityObserver {
...
extension VocationalWindowUIController: AgoraWidgetMessageObserver {
...
extension VocationalWindowUIController: AgoraEduStreamHandler {
...
extension VocationalWindowUIController: AgoraEduUserHandler {
...
// MARK: - AgoraEduMediaHandler
extension VocationalWindowUIController: AgoraEduMediaHandler {
...
private extension VocationalWindowUIController {
