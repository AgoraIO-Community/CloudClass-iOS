...
extension AgoraUserListUIController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.userName = studentModel.user.userName
        cell.coHostFlag = studentModel.coHost
...
extension AgoraUserListUIController: AgoraUserCellDelegate {
    func userCell(_ cell: AgoraUserCell,
        ...
        if mute {
            mediaContext?.unpublishStream(type: .video)
        } else {
            mediaContext?.publishStream(type: .video)
        }
