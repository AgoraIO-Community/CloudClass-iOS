...
extension UIImage {
    class func fcr_named(_ named: String) -> UIImage? {
        let bundle = Bundle.AgoraInvigilatorUI()
...
extension Bundle {
    class func AgoraInvigilatorUI() -> Bundle {
        return Bundle.agora_bundle("AgoraInvigilatorUI") ?? Bundle.main
    }
}
...
extension String {
    ...
    func fcr_invigilator_localized() -> String {
        guard let eduBundle = Bundle.agora_bundle("AgoraInvigilatorUI") else {
            return ""
        }
