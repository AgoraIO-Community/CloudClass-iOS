...
public class DisclaimerView: AgoraBaseUIView {
    ...
    private lazy var scrollView = AgoraBaseUIScrollView(frame: .zero)
...
private extension DisclaimerView {
    func initView() {
        ...
        scrollView.addSubview(disclaLabel)
    }
    ...
    func initLayout() {
        ...
        scrollView.agora_center_x = 0
        scrollView.agora_height = height - titleView.agora_height - LoginConfig.dis_title_sep
        scrollView.agora_width = width - LoginConfig.dis_label_x * 2
        scrollView.agora_y = LoginConfig.dis_title_height + LoginConfig.dis_title_sep
        
        disclaLabel.agora_center_x = 0
        disclaLabel.agora_width = width - LoginConfig.dis_label_x * 2
        disclaLabel.agora_y = 0
        disclaLabel.layoutIfNeeded()
        
        scrollView.contentSize = disclaLabel.frame.size
    }
}
