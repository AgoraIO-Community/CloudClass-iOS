...
@protocol AgoraReplaySliderViewDelegate <NSObject>
...
@interface AgoraReplaySliderButton : UIButton

@end

NS_ASSUME_NONNULL_BEGIN

@interface AgoraReplaySliderView : UIView

@property (nonatomic, weak) id<AgoraReplaySliderViewDelegate> delegate;

/** slider */
@property (nonatomic, strong, readonly) AgoraReplaySliderButton *sliderBtn;
