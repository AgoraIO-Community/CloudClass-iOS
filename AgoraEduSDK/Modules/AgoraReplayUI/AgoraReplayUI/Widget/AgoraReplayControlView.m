...
@interface AgoraReplayControlView()<AgoraReplaySliderViewDelegate>

@end

@implementation AgoraReplayControlView
...
#pragma mark AgoraReplaySliderViewDelegate
