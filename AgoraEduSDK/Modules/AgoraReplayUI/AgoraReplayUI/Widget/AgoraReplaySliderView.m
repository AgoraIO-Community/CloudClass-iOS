...
#import "AgoraReplaySliderView.h"
...
@implementation AgoraReplaySliderButton
...
@interface AgoraReplaySliderView ()
...
@property (nonatomic, strong) AgoraReplaySliderButton *sliderBtn;
...
@implementation AgoraReplaySliderView
...
- (AgoraReplaySliderButton *)sliderBtn {
    if (!_sliderBtn) {
        _sliderBtn = [AgoraReplaySliderButton buttonWithType:UIButtonTypeCustom];
