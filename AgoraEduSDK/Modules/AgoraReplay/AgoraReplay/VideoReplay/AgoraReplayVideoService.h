...
@protocol AgoraReplayVideoProtocol <NSObject>
...
@interface AgoraReplayVideoService : NSObject

@property (nonatomic, weak, nullable) id<AgoraReplayVideoProtocol> delegate;

- (void)initWithConfiguration:(AgoraReplayConfiguration *)config success:(void (^) (AVPlayer *avPlayer))successBlock failure:(void (^) (NSError * error))failBlock;
