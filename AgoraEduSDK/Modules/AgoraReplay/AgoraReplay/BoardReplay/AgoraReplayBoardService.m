...
@interface AgoraReplayBoardService()<WhiteCommonCallbackDelegate, WhitePlayerEventDelegate>
@property (nonatomic, strong) WhiteSDK * _Nullable whiteSDK;
@property (nonatomic, strong) NSString *appId;
@end

@implementation AgoraReplayBoardService

- (void)initWithConfiguration:(AgoraReplayConfiguration *)config success:(void (^) (UIView *boardView))successBlock failure:(void (^) (NSError * error))failBlock {
