...
@protocol AgoraReplayBoardProtocol <NSObject>
...
@interface AgoraReplayBoardService : NSObject
...
@property (nonatomic, weak, nullable) id<AgoraReplayBoardProtocol> delegate;
