...
@interface AgoraBCSegmentedView ()
@property (nonatomic, copy) NSArray *items;
@end

@implementation AgoraBCSegmentedView
- (instancetype)initWithCoder:(NSCoder *)coder
{
    self = [super initWithCoder:coder];
    if (self) {
        self.items = [NSArray arrayWithObjects:AgoraEduLocalizedString(@"MaterialsAreaText", nil), AgoraEduLocalizedString(@"ChatroomText", nil), nil];
    }
