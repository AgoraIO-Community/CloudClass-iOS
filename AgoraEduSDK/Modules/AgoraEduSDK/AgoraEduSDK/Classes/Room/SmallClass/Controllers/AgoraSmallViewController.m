...
@interface AgoraSmallViewController ()<UITextFieldDelegate, AgoraRoomProtocol, AgoraRTEClassroomDelegate, AgoraRTEStudentDelegate>
...
- (void)reloadStudentViews {
    ...
    [AgoraEduManager.shareManager.roomManager getFullStreamListWithSuccess:^(NSArray<AgoraRTEStream *> * _Nonnull streams) {
         ...
         NSPredicate *predicate = [NSPredicate predicateWithFormat:@"userInfo.role != %d", AgoraRTERoleTypeTeacher];
