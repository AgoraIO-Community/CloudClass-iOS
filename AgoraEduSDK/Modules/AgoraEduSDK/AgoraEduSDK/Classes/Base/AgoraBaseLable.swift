...
@objcMembers public class AgoraBaseLable: UILabel {
...
// MARK: Rect
extension AgoraBaseLable {
    
    func move(_ x: CGFloat, _ y: CGFloat) -> AgoraBaseLable {
        self.x = x
        self.y = y
        return self
    }
    
    func resize(_ width: CGFloat, _ height: CGFloat) -> AgoraBaseLable {
        self.width = width
        self.height = height
        return self
    }
