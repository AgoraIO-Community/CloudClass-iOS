...
#define AgoraLogLocalErrorDomain @"io.agora.AgoraLog"
#define AgoraLogLocalError(errCode, reason) ([NSError errorWithDomain:AgoraLogLocalErrorDomain \
    code:(errCode) \
userInfo:@{NSLocalizedDescriptionKey:(reason)}])

NS_ASSUME_NONNULL_BEGIN

@interface AgoraLogOSSManager : NSObject
